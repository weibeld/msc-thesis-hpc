...
:CONSOLE
%JAVA% %JVMARGS% -Dorg.apache.commons.logging.Log=org.apache.commons.logging.impl.SimpleLog -Dorg.apache.commons.logging.simplelog.log.org.java.plugin=fatal -jar lib\jpf-boot.jar %*
GOTO END

:UI
start "GOAL" %JAVA% %JVMARGS% -Dorg.apache.commons.logging.Log=org.apache.commons.logging.impl.SimpleLog -Dorg.apache.commons.logging.simplelog.log.org.java.plugin=fatal -jar lib\jpf-boot.jar
GOTO END
